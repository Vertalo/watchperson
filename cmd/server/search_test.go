...
func init() {
	...
	ssiSearcher.SSIs = precomputeCSLEntities([]*csl.SSI{
		{
			EntityID:       "18782",
			Type:           "Entity",
	...
	meuSearcher.MilitaryEndUsers = precomputeCSLEntities([]*csl.MEU{
		{
	...
	bisEntitySearcher.BISEntities = precomputeCSLEntities([]*csl.EL{
		{
